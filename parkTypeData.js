    ...
    // let parkTypeDropdownEl = document.getElementById("parkType");
    ...
    //         option.value = type;
    //         option.text = type;
    //         parkTypeDropdownEl.appendChild(option);
    //       });
   
    // function populateParkTypeDropdown() {
    //     parksArray.forEach(park => {
    //     //   let LocationName = park.LocationName;
    //     //   if (parkTypeDropdownEl.querySelector(`option[value="${LocationName}"]`)) {
    //     //     let option = document.createElement("option");
    ...
    //       }
    //     });
    //     parkDropdownEl.style.display = selectedState ? "block" : "none";
    //   }
    ...
    //     let selectedParkType = parkTypeDropdownEl.value;
    //     populateParkTypeDropdown(selectedParkType);
    //   });