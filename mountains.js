...
let mountainInfoEl = document.getElementById("mountain-info");
let mountainValuesEl = document.getElementById("mountain-value");
...
mountainInfoEl.innerHTML = "";

mountainsArray.forEach((mountain)=>{
    let optionEl = document.createElement("option");
    optionEl.value = mountain.name;
    optionEl.textContent = mountain.name;
    mountainInfoEl.appendChild(optionEl);
})

mountainInfoEl.onchange = function(){
    let mountainSelected = mountainInfoEl.value;
    for(let info of mountainsArray){
        if(info.name === mountainSelected){
            mountainValuesEl.innerHTML = "";
            
            let nameEl = document.createElement("p");
            nameEl.textContent = info.name;
            mountainValuesEl.appendChild(nameEl);

            let descEl = document.createElement("p");
            descEl.textContent = info.desc;
            mountainValuesEl.appendChild(descEl);

            let imgEl = document.createElement("img");
            imgEl.src = info.img;
            imgEl.alt = info.name;
            mountainValuesEl.appendChild(imgEl);
